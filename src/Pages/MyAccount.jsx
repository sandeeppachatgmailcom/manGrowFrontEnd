...
const MyAccount = () => {
    ...
    return (
        <div style={{ height: '100vh' }} className={`${theme}  container-flex m-10`}>
            <div className="container-flex flex items-center justify-center ">
                <h5>Info about you and your preferences across Mangrow services</h5>
            </div>
            <br />
            <br />
            ...
            <br />
            <div className="container-flex  border  border-gray-300 rounded-xl   flex items-center justify-start ">
